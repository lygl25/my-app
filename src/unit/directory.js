...
const directory=[
    {
      ...
      model: false,
      children: [
        { id:1,text: "为什么是Web而不是Unity？" ,articleContent:WhyWebandnotUnity},
        { id:2,text: "为什么使用现代JavaScript",articleContent:"内容2" },
        { id:3,text: "如何使用这本书",articleContent:"内容3" },
        { id:4,text: "示例源码" ,articleContent:"内容4"},
      ],
    },
    {
      ...
      model: false,
      children: [
        { id:5,text: "创建新文件夹",articleContent:"(未完成)" },
        { id:6,text: "开发服务器",articleContent:"(未完成)"  },
        { id:7,text: "创建index.html",articleContent:"(未完成)"  },
        { id:8,text: "创建入口点" ,articleContent:"(未完成)" },
        { id:9,text: "让我们去直播吧" ,articleContent:"(未完成)" },
        { id:10,text: "现代JavaScript",articleContent:"(未完成)"  },
        { id:11,text: "使用模块",articleContent:"(未完成)"  },
        { id:12,text: "VS代码IntelliSense" ,articleContent:"(未完成)" },
        { id:13,text: "准备好，一号9号选手",articleContent:"(未完成)"  },
      ],
    },
    {
